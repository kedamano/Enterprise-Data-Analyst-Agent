        ...
        >
          <div className="flex h-full w-[272px] flex-col">
            ...
            <div className="shrink-0 px-2.5 pt-2.5">
              <button
                onClick={onNew}
                className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-indigo-200 bg-gradient-to-br from-indigo-500 to-violet-600 px-3 py-2 text-[13px] font-medium text-white shadow-sm shadow-indigo-500/30 transition hover:from-indigo-600 hover:to-violet-700"
              >
            ...
            <div className="flex shrink-0 items-center justify-between px-3.5 pt-3">
              ...
              <span className="text-[11.5px] tabular-nums text-slate-300">
            ...
            <div className="mt-1.5 min-h-0 flex-1 space-y-0.5 overflow-y-auto px-2 pb-2">
              {conversations.length === 0 && (
                <div className="mx-1.5 rounded-lg border border-dashed border-slate-200 px-3 py-6 text-center text-[12.5px] leading-relaxed text-slate-400">
                  还没有会话
                  <br />
                  在右侧直接提问即可开始
                </div>
              ...
              {conversations.map((c) => (
                ...
                >
                  ...
                  <span className="relative grid h-6 w-12 shrink-0 place-items-center">
                    <span className="absolute right-0 text-[11px] tabular-nums text-slate-400 transition group-hover:opacity-0">
                    ...
                    <button
                      ...
                      aria-label="删除会话"
                      title="删除会话"
                      className="absolute right-0 grid h-6 w-6 place-items-center rounded-md text-slate-400 opacity-0 transition hover:bg-rose-50 hover:text-rose-600 group-hover:opacity-100"
                    >
            ...
            <div className="flex shrink-0 items-center gap-1.5 border-t border-slate-200/70 px-3.5 py-2 text-[11.5px] text-slate-400">
